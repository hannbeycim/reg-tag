...
class Rolsüzver extends Command {
    ...
    async run(message, args, data) {
        ...
        let tagolan2 = message.guild.members.cache.filter(s => s.user.username.includes(server.Tag2) && !s.roles.cache.has(`${server.FamilyRole}`))
        let tagolan3 = message.guild.members.cache.filter(s => s.user.username.includes(server.Tag3) && !s.roles.cache.has(`${server.FamilyRole}`))
        let tagolan4 = message.guild.members.cache.filter(s => s.user.username.includes(server.Tag5) && !s.roles.cache.has(`${server.FamilyRole}`))
        let tagolan5 = message.guild.members.cache.filter(s => s.user.username.includes(server.Tag5) && !s.roles.cache.has(`${server.FamilyRole}`))
        let tagolan6 = message.guild.members.cache.filter(s => s.user.username.includes(server.Etiket) && !s.roles.cache.has(`${server.FamilyRole}`))           
        ...
        let tagolmayan2 =  message.guild.members.cache.filter(s => s.roles.cache.has(`${server.FamilyRole}`) && !s.user.username.includes(server.Tag2))
        let tagolmayan3 =  message.guild.members.cache.filter(s => s.roles.cache.has(`${server.FamilyRole}`) && !s.user.username.includes(server.Tag3))
        let tagolmayan4 =  message.guild.members.cache.filter(s => s.roles.cache.has(`${server.FamilyRole}`) && !s.user.username.includes(server.Tag4))
        let tagolmayan5 =  message.guild.members.cache.filter(s => s.roles.cache.has(`${server.FamilyRole}`) && !s.user.username.includes(server.Tag5))
        let tagolmayan6 =  message.guild.members.cache.filter(s => s.roles.cache.has(`${server.FamilyRole}`) && !s.user.username.includes(server.Etiket))
