...
.addComponents(
  ...
  new Discord.MessageButton()
   ...
   .setDescription(`
**1- Normal teyit (.e @Ramalask Ramal 22)**
**2- Buttonlu teyit (.isim @Ramalask Ramal 22 - Button seçim)**
**3- Etiketsiz teyit (.isim @Ramalask Ramal 22 - .e)**
...
const collector = msg.createMessageComponentCollector({ filter, time: 30000 })
    ...
    collector.on("collect", async (button) => {
      ...
      server.save();
      button.reply("Teyit modu cinsiyet olarak değiştirildi. Artık \`.e @Ramalask Ramal 22\` ile kayıt yapılabilecek")
        ...
        button.reply("Teyit modu buttonlu olarak değiştirildi. Artık \`.isim @Ramalask Ramal 22 - Button seçim\` ile kayıt yapılabilecek")
        ...
        button.reply("Teyit modu etiketsiz olarak değiştirildi. Artık \`.isim @Ramalask Ramal 22 - .e\` ile kayıt yapılabilecek")
